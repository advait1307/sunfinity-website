    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-3">Database Services</h2>
            <p className="text-[#ed8416] font-semibold">Design · Implementation . Maintenance</p>
          </motion.div>
